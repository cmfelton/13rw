## This is the script for conducting the
## sample-splitting, type-M, and measurement 
## error simulations. Some functions are copied
## from analysis.R to read in the data,
## produce ts objects, and calculate
## conformal p-values.
